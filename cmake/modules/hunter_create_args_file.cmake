...
function(hunter_create_args_file args filename)
  ...
  foreach(entry ${args})
    ...
    if(equal_symbol_index EQUAL -1)
      ...
      math(EXPR preceding_pos "${equal_symbol_index} - 1")
      if(${equal_symbol_index} GREATER 0)
        string(SUBSTRING ${entry} ${preceding_pos} 1 preceding_char)
        if (${preceding_char} STREQUAL "\\")
