...
hunter_default_version(Clang VERSION 11.1.0-t03)
...
hunter_default_version(LLVM VERSION 11.1.0-t03) # Clang
...
hunter_default_version(OpenBLAS VERSION 0.3.14)
hunter_default_version(OpenCL VERSION 2.1-p3)
hunter_default_version(OpenCL-cpp VERSION 2.0.10-p0)
hunter_default_version(OpenCV VERSION 4.2.0-t3)
hunter_default_version(OpenCV-Extra VERSION 4.2.0)
...
hunter_default_version(PNG VERSION 1.6.36-t3)
...
hunter_default_version(PostgreSQL VERSION 13.2-t0)
...
hunter_default_version(cnpy VERSION 1.0.2)
...
hunter_default_version(g3log VERSION 1.3.4)
...
hunter_default_version(glib VERSION 2.58.3)
...
hunter_default_version(gst_libav VERSION 1.16.3)
hunter_default_version(gst_plugins_bad VERSION 1.16.3)
hunter_default_version(gst_plugins_base VERSION 1.16.3)
hunter_default_version(gst_plugins_good VERSION 1.16.3)
hunter_default_version(gst_plugins_ugly VERSION 1.16.3)
hunter_default_version(gstreamer VERSION 1.16.3)
...
hunter_default_version(libpqxx VERSION 7.5.0)
...
hunter_default_version(mkldnn VERSION 2.2.0-t0)
...
hunter_default_version(mxnet VERSION 1.6.0-t0)
...
hunter_default_version(videoproto VERSION 2020.1-deb)
...
hunter_default_version(xv VERSION 1.0.11-deb)
